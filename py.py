...
bot = telebot.TeleBot('7782402718:AAG4qcndgy34Tlra1D7w3oz4UD5Zhp5p5ZY')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\n"
                    ...
                    "👉 Contact an Admin or the Owner @demog1  for approval.\n"
                    "🌟 Become a proud supporter and purchase approval.\n"
                    "💬 Chat with an Owner @demog1 now and level up your capabilities!\n\n"
...
def welcome_start(message):
    ...
    response = (
        f"🥀Welcome {user_name}!\n\n"
        " For User ID : /id \n\n"
        "👉 Join our official channel - NONE\n\n"
        "👑 For access: @demog1 "
        "👑 OWNER : @demog1 "
    )
    bot.reply_to(message, response)
...
def clear_logs_handler(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "Only @demog1 can run this command.")
